...
from src2.Instrucciones.Break import Break
from src2.Instrucciones.Continue import Continue
from src2.Instrucciones.AccesoA import AccessArray
...
from src2.Instrucciones.ciclo_forA import ForArray
...
#from src2.Instrucciones.CreaS import CreaStruct
...
def p_instruccion_incrementable(t):
    '''expresionincr : ID MAS MAS
                | ID MENOS MENOS'''
    if t[2] == '+':
        t[0] = Asignacion_incrementable(t[1], "++" , t.lineno(2), get_Columna(input, t.slice[2]) )
    else:
        t[0] = Asignacion_incrementable(t[1], "--" , t.lineno(2), get_Columna(input, t.slice[2]))
